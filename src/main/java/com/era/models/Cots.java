...
@Entity @Table(name = "cots",uniqueConstraints = {@UniqueConstraint( columnNames ={"id_id"})}) public class Cots {
  ...
  @Column(name = "totdescu", nullable = true) private float totdescu;
  @Column(name = "totcost", nullable = true) private float totcost;
  @Column(name = "vta", nullable = true) private int vta = 0;
  ...
  @Column(name = "subtotgral", nullable = true) private float subtotgral;
  @Column(name = "subtotgral2", nullable = false) private float subtotgral2;
  @Column(name = "subtot", nullable = true) private float subtot;
  @Column(name = "manobr", nullable = true) private float manobr;
  @Column(name = "impue", nullable = true) private float impue;
  @Column(name = "subtotmat", nullable = true) private float subtotmat;
  @Column(name = "subtotmat2", nullable = false) private float subtotmat2;
  ...
  @Column(name = "MonedaID", nullable = true) private int MonedaID = 0;
