...
@Entity @Table(name = "cortszx",uniqueConstraints = {@UniqueConstraint( columnNames ={"id_id"})}) public class Cortszx {
  ...
  @Column(name = "numcort", nullable = false) private int numcort;
  @Column(name = "cort", nullable = false,length = 30) private String cort;
  @Column(name = "regis", nullable = true) private int regis = 0;
  @Column(name = "totvtas", nullable = false) private int totvtas;
  @Column(name = "totingr", nullable = true) private float totingr;
  @Column(name = "totegre", nullable = true) private float totegre;
  @Column(name = "totcaj", nullable = true) private float totcaj;
  @Column(name = "vtabruta", nullable = true) private float vtabruta = 0;
  @Column(name = "descu", nullable = true) private float descu = 0;
  @Column(name = "devs", nullable = true) private float devs = 0;
  @Column(name = "vtanet", nullable = true) private float vtanet = 0;
  @Column(name = "impue", nullable = true) private float impue = 0;
  @Column(name = "vtanetimp", nullable = true) private float vtanetimp = 0;
  @Column(name = "totfacs", nullable = true) private float totfacs = 0;
  @Column(name = "tottics", nullable = true) private float tottics = 0;
  @Column(name = "cantfac", nullable = true) private int cantfac = 0;
  @Column(name = "canttics", nullable = true) private int canttics = 0;
  @Column(name = "totefe", nullable = true) private float totefe = 0;
  @Column(name = "totdeb", nullable = true) private float totdeb = 0;
  @Column(name = "tottarcred", nullable = true) private float tottarcred = 0;
  @Column(name = "totdep", nullable = true) private float totdep = 0;  
