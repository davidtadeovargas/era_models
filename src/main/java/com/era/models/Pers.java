...
@Entity @Table(name = "pers",uniqueConstraints = {@UniqueConstraint( columnNames ={"id_id"})}) public class Pers {
  ...
  @Column(name = "act", nullable = true, columnDefinition = "boolean default false") private boolean act = true;
  ...
  @Column(name = "sueldactua", nullable = true, columnDefinition = "float default 0") private float sueldactua = 0;
  @Column(name = "textra", nullable = true, columnDefinition = "float default 0") private float textra = 0;
  @Column(name = "sueldfora", nullable = true, columnDefinition = "float default 0") private float sueldfora = 0;  
