...
@Entity @Table(name = "asocdesc") public class Asocdesc {
  ...
  @Column(name = "util", nullable = true, columnDefinition = "float default 0") private float util = 0;
  @Column(name = "list", nullable = true, columnDefinition = "int default 1") private int list = 1;
  @Column(name = "prec", nullable = true, columnDefinition = "float default 0") private float prec = 0;
