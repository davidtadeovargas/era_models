...
@Entity@Table(name = "er_permisos")public class ERPermisos {
  ...
  @Column(name = "FKIdUsuario", nullable = false) private int FKIdUsuario;
  @Column(name = "permisoConf", nullable = false) private boolean permisoConf = true;
  @Column(name = "permisoCorreos", nullable = false) private boolean permisoCorreos = true;
  @Column(name = "permisoDatosEmpresa", nullable = false) private boolean permisoDatosEmpresa = true;
  @Column(name = "permisoSeries", nullable = false) private boolean permisoSeries = true;
  @Column(name = "permisoImpresoras", nullable = false) private boolean permisoImpresoras = true;
  @Column(name = "permisoCambiarIcono", nullable = false) private boolean permisoCambiarIcono = true;
  @Column(name = "permisoConfiguracionesGenerales", nullable = false) private boolean permisoConfiguracionesGenerales = true;
  @Column(name = "otorgaPermisosConfig", nullable = false) private boolean otorgaPermisosConfig = true;
  @Column(name = "permisoUsuarios", nullable = false) private boolean permisoUsuarios = true;
  @Column(name = "permisoUsuariosDefinir", nullable = false) private boolean permisoUsuariosDefinir = true;
  @Column(name = "permisoUsuariosConectados", nullable = false) private boolean permisoUsuariosConectados = true;
  @Column(name = "permisoUsuariosPermisos", nullable = false) private boolean permisoUsuariosPermisos = true;
  @Column(name = "permisoClaves", nullable = false) private boolean permisoClaves = true;
  @Column(name = "permisoReparar", nullable = false) private boolean permisoReparar = true;
  @Column(name = "permisoRepararErrores", nullable = true) private int permisoRepararErrores = 1;
  @Column(name = "permisoRepararRestaurar", nullable = false) private boolean permisoRepararRestaurar = true;
  @Column(name = "permisoBaseDatos", nullable = false) private boolean permisoBaseDatos = true;
  @Column(name = "permisoBaseDatosConexiones", nullable = false) private boolean permisoBaseDatosConexiones = true;
  @Column(name = "permisoBaseDatosArchivo", nullable = false) private boolean permisoBaseDatosArchivo = true;
  @Column(name = "permisoReportes", nullable = false) private boolean permisoReportes = true;
  @Column(name = "permisoReportesUsuarios", nullable = false) private boolean permisoReportesUsuarios = true;
  @Column(name = "permisoReportesRespaldos", nullable = false) private boolean permisoReportesRespaldos = true;
  @Column(name = "permisoReportesLog", nullable = false) private boolean permisoReportesLog = true;
  @Column(name = "permisoReportesEstadistica", nullable = false) private boolean permisoReportesEstadistica = true;
  @Column(name = "permisoRevocacion", nullable = false) private boolean permisoRevocacion = true;
  @Column(name = "permisoActivarSistema", nullable = false) private boolean permisoActivarSistema = true;
  @Column(name = "otorgaPermisosSistema", nullable = false) private boolean otorgaPermisosSistema = true;
  @Column(name = "permisoContabilidad", nullable = false) private boolean permisoContabilidad = true;
  @Column(name = "permisoConceptosNC", nullable = false) private boolean permisoConceptosNC = true;
  @Column(name = "permisoCatalogoGarantias", nullable = false) private boolean permisoCatalogoGarantias = true;
  @Column(name = "permisoZonas", nullable = false) private boolean permisoZonas = true;
  @Column(name = "permisoGiros", nullable = false) private boolean permisoGiros = true;
  @Column(name = "permisoMonedas", nullable = false) private boolean permisoMonedas = true;
  @Column(name = "permisoImpuestos", nullable = false) private boolean permisoImpuestos = true;
  @Column(name = "otorgaPermisosModulos", nullable = false) private boolean otorgaPermisosModulos = true;
  @Column(name = "permisoCompras", nullable = false) private boolean permisoCompras = true;
  @Column(name = "permisoComprasCancelar", nullable = false) private boolean permisoComprasCancelar = true;
  @Column(name = "permisoComprasDevolucion", nullable = false) private boolean permisoComprasDevolucion = true;
  @Column(name = "permisoComprasParcial", nullable = false) private boolean permisoComprasParcial = true;
  @Column(name = "permisoComprasNuevo", nullable = false) private boolean permisoComprasNuevo = true;
  @Column(name = "permisoComprasNotCredito", nullable = false) private boolean permisoComprasNotCredito = true;
  @Column(name = "permisoComprasVer", nullable = false) private boolean permisoComprasVer = true;
  @Column(name = "permisoComprasCargarArchivo", nullable = false) private boolean permisoComprasCargarArchivo = true;
  @Column(name = "permisoComprasBorrarArchivo", nullable = false) private boolean permisoComprasBorrarArchivo = true;
  @Column(name = "permisoComprasRecibirOrden", nullable = false) private boolean permisoComprasRecibirOrden = true;
  @Column(name = "otorgaPermisosCompras", nullable = false) private boolean otorgaPermisosCompras = true;
  @Column(name = "permisoProvee", nullable = false) private boolean permisoProvee = true;
  @Column(name = "permisoProveeNuevo", nullable = false) private boolean permisoProveeNuevo = true;
  @Column(name = "permisoProveeModificar", nullable = false) private boolean permisoProveeModificar = true;
  @Column(name = "permisoProveeVer", nullable = false) private boolean permisoProveeVer = true;
  @Column(name = "permisoProveeBorrar", nullable = false) private boolean permisoProveeBorrar = true;
  @Column(name = "otorgaPermisosProvee", nullable = false) private boolean otorgaPermisosProvee = true;
  @Column(name = "permisoPrevio", nullable = false) private boolean permisoPrevio = true;
  @Column(name = "permisoPrevioNueva", nullable = false) private boolean permisoPrevioNueva = true;
  @Column(name = "permisoPrevioAbrir", nullable = false) private boolean permisoPrevioAbrir = true;
  @Column(name = "permisoPrevioVer", nullable = false) private boolean permisoPrevioVer = true;
  @Column(name = "permisoPrevioCancelar", nullable = false) private boolean permisoPrevioCancelar = true;
  @Column(name = "permisoPrevioSeries", nullable = false) private boolean permisoPrevioSeries = true;
  @Column(name = "permisoPrevioCompra", nullable = false) private boolean permisoPrevioCompra = true;
  @Column(name = "otorgaPermisosPrevio", nullable = false) private boolean otorgaPermisosPrevio = true;
  @Column(name = "permisoInventario", nullable = false) private boolean permisoInventario = true;
  @Column(name = "permisoProductos", nullable = false) private boolean permisoProductos = true;
  @Column(name = "permisoProductosNuevo", nullable = false) private boolean permisoProductosNuevo = true;
  @Column(name = "permisoProductosModificar", nullable = false) private boolean permisoProductosModificar = true;
  @Column(name = "permisProductosBorrar", nullable = false) private boolean permisProductosBorrar = true;
  @Column(name = "otorgaPermisosInventario", nullable = false) private boolean otorgaPermisosInventario = true;
  @Column(name = "permisoClientes", nullable = false) private boolean permisoClientes = true;
  @Column(name = "permisoClientesNuevo", nullable = false) private boolean permisoClientesNuevo = true;
  @Column(name = "permisoClientesModificar", nullable = false) private boolean permisoClientesModificar = true;
  @Column(name = "permisoClientesVer", nullable = false) private boolean permisoClientesVer = true;
  @Column(name = "permisoClientesBorrar", nullable = false) private boolean permisoClientesBorrar = true;
  @Column(name = "permisoClientesEnviar", nullable = false) private boolean permisoClientesEnviar = true;
  @Column(name = "otorgaPermisosClientes", nullable = false) private boolean otorgaPermisosClientes = true;
  @Column(name = "permisoVentas", nullable = false) private boolean permisoVentas = true;
  @Column(name = "permisoVentasCancelar", nullable = false) private boolean permisoVentasCancelar = true;
  @Column(name = "permisoVentasDevolucion", nullable = false) private boolean permisoVentasDevolucion = true;
  @Column(name = "permisoVentasParcial", nullable = false) private boolean permisoVentasParcial = true;
  @Column(name = "permisoVentasNueva", nullable = false) private boolean permisoVentasNueva = true;
  @Column(name = "permisoVentasNotCredito", nullable = false) private boolean permisoVentasNotCredito = true;
  @Column(name = "permisoVentasVer", nullable = false) private boolean permisoVentasVer = true;
  @Column(name = "permisoVentasEnviar", nullable = false) private boolean permisoVentasEnviar = true;
  @Column(name = "permisoVentasTimbrar", nullable = false) private boolean permisoVentasTimbrar = true;
  @Column(name = "permisoVentasEntregar", nullable = false) private boolean permisoVentasEntregar = true;
  @Column(name = "permisoVentasComprobar", nullable = false) private boolean permisoVentasComprobar = true;
  @Column(name = "permisoVentasAcuse", nullable = false) private boolean permisoVentasAcuse = true;
  @Column(name = "permisoVentasObtenerXml", nullable = false) private boolean permisoVentasObtenerXml = true;
  @Column(name = "permisoVentasFacturar", nullable = false) private boolean permisoVentasFacturar = true;
  @Column(name = "permisoVentasCargarArchivo", nullable = false) private boolean permisoVentasCargarArchivo = true;
  @Column(name = "permisoVentasBorrarArchivo", nullable = false) private boolean permisoVentasBorrarArchivo = true;
  @Column(name = "otorgaPermisosVentas", nullable = false) private boolean otorgaPermisosVentas = true;
  @Column(name = "permisoCotiza", nullable = false) private boolean permisoCotiza = true;
  @Column(name = "permisoCotizaNueva", nullable = false) private boolean permisoCotizaNueva = true;
  @Column(name = "permisoCotizaAbrir", nullable = false) private boolean permisoCotizaAbrir = true;
  @Column(name = "permisoCotizaVer", nullable = false) private boolean permisoCotizaVer = true;
  @Column(name = "permisoCotizaCancelar", nullable = false) private boolean permisoCotizaCancelar = true;
  @Column(name = "permisoCotizaReenviar", nullable = false) private boolean permisoCotizaReenviar = true;
  @Column(name = "permisoCotizaVenta", nullable = false) private boolean permisoCotizaVenta = true;
  @Column(name = "otorgaPermisosCotiza", nullable = false) private boolean otorgaPermisosCotiza = true; 
  @Column(name = "permisoCxc", nullable = false) private boolean permisoCxc = true;
  @Column(name = "permisoPagoNuevo", nullable = false) private boolean permisoPagoNuevo = true;
  @Column(name = "permisoCancelarPago", nullable = false) private boolean permisoCancelarPago = true;
  @Column(name = "otorgaPermisoCxc", nullable = false) private boolean otorgaPermisoCxc = true;
  @Column(name = "permisProductosListaPrecio", nullable = false) private boolean permisProductosListaPrecio = true;
  @Column(name = "permisProductosCargadoImagen", nullable = false) private boolean permisProductosCargadoImagen = true;
