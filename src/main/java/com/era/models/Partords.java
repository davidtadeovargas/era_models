...
@Entity @Table(name = "partords") public class Partords {
  ...
  @Column(name = "descu", nullable = false, columnDefinition = "int default 0") private int descu;
  @Column(name = "descad", nullable = false, columnDefinition = "int default 0") private int descad;
  @Column(name = "impue", nullable = false,length = 30) private String impue;
  @Column(name = "impueval", nullable = false, columnDefinition = "int default 0") private int impueval;
  @Column(name = "ultcost", nullable = true, columnDefinition = "float default 0") private float ultcost;
  @Column(name = "impo", nullable = true, columnDefinition = "float default 0") private float impo;
  @Column(name = "impoimpue", nullable = true, columnDefinition = "float default 0") private float impoimpue;  
