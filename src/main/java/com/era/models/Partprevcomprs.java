...
@Entity @Table(name = "partprevcomprs") public class Partprevcomprs {
  ...
  @Column(name = "cantlotpend", nullable = true) private float cantlotpend;
  ...
  @Column(name = "costpro", nullable = true) private float costpro;
  ...
  @Column(name = "peps", nullable = true) private float peps = 0;
  @Column(name = "ueps", nullable = true) private float ueps = 0;
  @Column(name = "descu", nullable = true) private float descu;
  @Column(name = "descad", nullable = true) private float descad;
  @Column(name = "recib", nullable = true) private float recib = 0;
