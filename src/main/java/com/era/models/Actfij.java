...
@Entity @Table(name = "actfij", uniqueConstraints = {@UniqueConstraint(columnNames = {"id_id"})}) public class Actfij {
  ...
  @Column(name = "porcendep", nullable = true) private float porcendep;
  @Column(name = "porcendedu", nullable = true) private float porcendedu;
  @Column(name = "cost", nullable = true) private float cost;
  @Column(name = "sal", nullable = true) private boolean sal = false;
  @Column(name = "exportconta", nullable = true) private boolean exportconta = false;
  @Column(name = "totmesbaj", nullable = true) private int totmesbaj = 0;
  @Column(name = "totacumes", nullable = true) private float totacumes = 0;
  @Column(name = "totvalactbaj", nullable = true) private float totvalactbaj = 0;
  @Column(name = "totestadbaj", nullable = true, length = 30) private String totestadbaj = "";
  @Column(name = "costsal", nullable = true) private float costsal = 0;
  ...
  @Column(name = "baj", nullable = true) private boolean baj = false;  
