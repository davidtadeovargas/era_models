...
@Entity@Table(name = "pedidos_parts")public class PedidosParts {
  ...
  @Index(name="pedidoID") @Column(name = "pedidoID", nullable = false, columnDefinition = "int default 0") private int pedidoID;
  ...
  @Column(name = "recibidas", nullable = false, columnDefinition = "int default 0") private int recibidas;
