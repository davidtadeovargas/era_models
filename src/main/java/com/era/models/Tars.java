...
@Entity @Table(name = "tars",uniqueConstraints = {@UniqueConstraint( columnNames ={"id_id"})}) public class Tars {
  ...
  @Column(name = "tar", nullable = false) private int tar;
  @Column(name = "vta", nullable = true) private int vta = 0;
  @Column(name = "pag", nullable = false) private boolean pag;
  @Column(name = "loc", nullable = false) private boolean loc;
  @Column(name = "exter", nullable = false) private boolean exter;
  @Column(name = "prepag", nullable = false) private boolean prepag;
  @Column(name = "factuya", nullable = false) private boolean factuya;
  @Column(name = "ffactu", nullable = false) private Date ffactu = new Date();
  @Column(name = "factur", nullable = false) private boolean factur;
  @Column(name = "tarif", nullable = true) private float tarif;  
