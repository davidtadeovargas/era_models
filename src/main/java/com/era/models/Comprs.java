...
@Entity @Table(name = "comprs",uniqueConstraints = {@UniqueConstraint( columnNames ={"id_id"})}) public class Comprs {
  ...
  @Column(name = "referencia", nullable = true) private String referencia;
  ...
  @Column(name = "archpdf", nullable = true) private boolean archpdf = false;
  @Column(name = "archxml", nullable = true) private boolean archxml = false;
  @Column(name = "recib", nullable = true) private BigDecimal recib = BigDecimal.ZERO;
  @Column(name = "contra", nullable = true) private int contra = 0;
  ...
  @Column(name = "total_traslado", nullable = false) private BigDecimal total_traslado = BigDecimal.ZERO;
  @Column(name = "total_retencion", nullable = false) private BigDecimal total_retencion = BigDecimal.ZERO;
