...
@Entity @Table(name = "petis",uniqueConstraints = {@UniqueConstraint( columnNames ={"id_id"})}) public class Petis {
  ...
  @Column(name = "val", nullable = false, columnDefinition = "boolean default false") private boolean val;
  @Column(name = "estad", nullable = false, columnDefinition = "boolean default false") private boolean estad;
