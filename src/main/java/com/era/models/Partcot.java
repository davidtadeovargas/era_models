...
@Entity @Table(name = "partcot") public class Partcot {
  ...
  @Column(name = "cost", nullable = true, columnDefinition = "float default 0") private float cost = 0;
  ...
  @Column(name = "pre", nullable = true, columnDefinition = "float default 0") private float pre;
  @Column(name = "pre2", nullable = false, columnDefinition = "float default 0") private float pre2;
  @Column(name = "desc1", nullable = false, columnDefinition = "float default 0") private float desc1;
  @Column(name = "desc2", nullable = false, columnDefinition = "float default 0") private float desc2;
  @Column(name = "desc3", nullable = false, columnDefinition = "float default 0") private float desc3;
  @Column(name = "desc4", nullable = false, columnDefinition = "float default 0") private float desc4;
  @Column(name = "desc5", nullable = false, columnDefinition = "float default 0") private float desc5;
  @Column(name = "impo", nullable = true, columnDefinition = "float default 0") private float impo;
  @Column(name = "impo2", nullable = false, columnDefinition = "float default 0") private float impo2;
  @Column(name = "impueval", nullable = true, columnDefinition = "float default 0") private float impueval;
  @Column(name = "impueimpo", nullable = true, columnDefinition = "float default 0") private float impueimpo;
  @Column(name = "impueimpo2", nullable = false, columnDefinition = "float default 0") private float impueimpo2;
  @Column(name = "impodesc", nullable = true, columnDefinition = "float default 0") private float impodesc = 0;
